...
const calcularIMC =function (altura, peso){
    ...
    imc > 18.5 && imc < 25 && console.log("Normal")
    imc > 25 && imc < 27 && console.log("Sobrepeso grado |")
    imc > 27 && imc < 30 && console.log("Sobrepeso grado ||")
    imc > 30 && imc < 35 && console.log("Obesidad grado |")
    imc > 35 && imc < 40 && console.log("Obesidad grado ||")
    imc > 40 && imc < 45 && console.log("Obesidad grado |||")
